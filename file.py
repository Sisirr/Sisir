...
────────────────────────────────────────────────────────────────────────
\033[1;36m<><><><><><><>><><><><><><><><>><><><><><><><><>><><>
           Maker  : \033[1;36mSisir here\033[0m
\033[1;36m           Designer  : Sisir
 \033[1;36m          Tools  : FILE MAKING
\033[1;36m           Facebook  : Scapegoat Sisir
\033[1;36m<><><><><><><>><><><><><><><><>><><><><><><><><>><><>""".format('\n',50*'=',50*'=')
...
def main_menu():
	...
	print(" NEW FILE DUMP TOOLS BY SISIR:) ")
	print(50*'=')
	print('[01] Would you like to Create a simple file')
	print('[02] Would you like to Create an unlimited file')
	print('[03] Would you like to remove duplicate')
	print('[04] Would you like to Re-login cookie ')
	print('[00] Wanna Exit tool ')
	print(50 * '=')
	menu = input('Pick up an suitable Option to proceed>> ')
	if menu in ['01','1']:
	...
	if menu in ['04','4']:
		cookie_remover()
	if menu in ['00','0']:
		exit('Thanks For Using Sisirs tool !')
	else:
		exit(' invalid ')
siid=[]
sep=[]
class file_create_menu():
	...
	def file_unlimmited(self):
		...
		if sepr in ['y','Y']:
			sep.append('y')
			print('\n\033[1;92m Example: 10007,10008,10009 (10000,10001 series for old id)\033[0;97m')
			try:
